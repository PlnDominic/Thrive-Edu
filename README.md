...
- `src/components/ui`: core primitives (Button, Input family, Select, Table, Toast, Alert, Skeleton, and more)
- `src/components/nav`: Sidebar, Topbar, mobile drawer + tab bar, Breadcrumbs
- `src/components/marketing`: SiteHeader, SiteFooter, CourseCard, SectionHeading
